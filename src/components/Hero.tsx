      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 lg:gap-16 items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-on-surface-variant text-lg max-w-md mb-8 leading-relaxed">
            Software engineer at Kiwi.com. 7+ years building authentication and
            user infrastructure for millions of travellers.
          </p>
        ...
        <div className="hidden md:flex items-center justify-center">
          <button
            ...
            className="w-36 md:w-44 lg:w-56 xl:w-64 aspect-square rounded-full overflow-hidden border-4 border-surface shadow-lg cursor-pointer hover:scale-105 transition-all duration-300 active:scale-95 focus:outline-none flex-shrink-0"
          >
            <img
